...
limitations. The new [benchmark](BENCHMARKS.md) is authorized research development,
not a retroactive change to those decisions. It adds actual GDN applicability
checks and independent GDN2 operator measurements. No pretrained GDN2 language
...
New documents are generated by three fixed synthetic families. Independent RNG
