...
| fixed-mask-codec-feedback | `RTPA_FIXED_MASK_CODEC_FEEDBACK_20260912_V1` | Reused TRAIN6 × 256, layers 0/12/22, two codecs sharing old DIAG8 masks | CPU equation replay and snapshot diagnostics; 18/18 cases; Native-fidelity control failed 7/18; no model inference; [diagnostic and scope](CODEC_FEEDBACK.md) |
